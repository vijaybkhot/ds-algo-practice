...
class PriorityQueue:
    ...
    def enqueue(self, value, priority):
        new_node = Node(value=value, priority=priority)
    ...
    def dequeue(self):
        if len(self.queue) > 1:
            ...
            while child_index < len(self.queue):
                ...
                if child_index < len(self.queue) - 1 and child.priority < self.queue[child_index + 1].priority:
