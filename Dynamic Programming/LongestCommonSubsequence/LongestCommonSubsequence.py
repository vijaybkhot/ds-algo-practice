...
def lcs_bottom_up_space_optimized(s1, s2):
    m = len(s1)
    n = len(s2)
...
s2 = "ace"
# LCS is "ace"
assert lcs_bottom_up_space_optimized(s1, s2) == "ace"

# Test case 2: Both strings are empty
s1 = ""
s2 = ""
# LCS is ""
assert lcs_bottom_up_space_optimized(s1, s2) == ""
...
s2 = "cdf"
# LCS is "cd"
assert lcs_bottom_up_space_optimized(s1, s2) == "cd"

# Test case 6: Strings are equal
s1 = "abcde"
s2 = "abcde"
# LCS is "abcde"
assert lcs_bottom_up_space_optimized(s1, s2) == "abcde"
